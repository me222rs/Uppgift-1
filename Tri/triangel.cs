...
public class Triangle {
  ...
  public Triangle(double a, double b, double c) {       //Här skickas sidornas värde in
  ...
  public Triangle(Point a, Point b, Point c) {      //Koordinatvärden       
    sides = new double[3];
  ...
  public Triangle(Point[] s) {              
    ...
    sides[1] = Math.Sqrt(Math.Pow((double)(s[1].x - s[2].x), 2.0) + Math.Pow((double)(s[1].x - s[0/*Ändrat här*/].x), 2.0));  //Ändrat [2] till [0] för att det ska fungera korrekt
  ...
  public bool isScalene() {     //Kollar om det är 3 stycken olika sidor
    if(uniqueSides()==3)
      return true;
    return false;
  }

  public bool isEquilateral() { //Kollar om det är 3 stycken likadana sidor
    if(uniqueSides()==1)
      return true;
    return false;
  }

  public bool isIsosceles() {   //Kollar om det är 2 stycken lika sidor
    if(uniqueSides()==2)
      return true;
    return false;
  }
